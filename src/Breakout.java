...
/** Runs the Breakout program. */
	...
	/**
	 * ≥н≥ц≥ал≥зуЇ вс≥ звуки, таймер, цикл гри
	 */
	...
	/**
	 * розраховуЇ коЇф≥ц≥Їнт зб≥льшенн€ швидкост≥
	 */
	...
	/**
	 * метод €кий прибираЇ вс≥ елементи ≥ запускаЇ в≥кно поразки/перемоги
	 */
	...
	/**
	 * перев≥р€Ї м€чик на кол≥з≥ю з≥ ст≥нами, ракеткою, цеглинами
	 */
	...
	/**
	 * прибираЇ р≥зн≥цю заходженн€ м€ча за пол€ гри
	 */
	...
	/**
	 * знаходить обЇкт попереду
	 * @return повертаЇ true €кщо обЇкт попереду цеглина або ракетка
	 */
	...
	/**
	 * перев≥р€Ї чи Ї цей обЇкт цеглиною або ракеткою
	 * @param obj обЇкт, що перев≥р€Їтьс€
	 * @return повертаЇ true, €кщо обЇкт цеглина або ракетка
	 */
	...
	/**
	 * змн≥Ї швидк≥сть, дивл€чись на кол≥р м€ча
	 * @param brickColor кол≥р м€ча
	 */
	...
	/**
	 * зб≥льшуЇ швидк≥сть м€ча
	 * @param n номер кольору м€ча
	 * @param k коеф≥ц≥Їнт зб≥льшен€ швидкост≥
	 */
	...
	/**
	 * ≥н≥ц≥ал≥зуЇ м€ч та надаЇ йому початкову швидк≥сть
	 */
	...
	/**
	 * повертаЇ наступний кол≥р цеглини за номером кольору цеглини
	 * @param num номер кольору
	 * @return кол≥р цеглини
	 */
	...
	/**
	 * знаходить потр≥бний кол≥р цеглини дивл€чись на њњ р€док
	 * @param i р€док цеглини
	 * @return кол≥р цеглини
	 */
	...
	/**
	 * рухаЇ ракеку, €кщо в гр≥, або передаЇ mouseEvent в меню, €кщо не в гр≥
	 * @param e mouseEvent
	 */
	...
	/**
	 * €кщо не в гр≥ передаЇ MouseEvent в меню
	 * @param e MouseEvent
	 */
	...
	/**
	 * ≥н≥ц≥ал≥зуЇ сердц€(к≥льк≥сть житт≥в)
	 */
	...
	/**
	 * оновлюЇ рахунок дивл€чись на кол≥р цеглини
	 * @param brickColor кол≥р збитоњ цеглини
	 */
